...
class _$GCreateTodoReq extends GCreateTodoReq {
  ...
  factory _$GCreateTodoReq([void Function(GCreateTodoReqBuilder)? updates]) =>
      (new GCreateTodoReqBuilder()..update(updates))._build();
  ...
  _$GCreateTodoReq._(
      ...
      this.context})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(vars, r'GCreateTodoReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, r'GCreateTodoReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, r'GCreateTodoReq', 'executeOnListen');
  }
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GCreateTodoReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
